...
class RPS_DefaultOptions {
	...
	public function createOptions() {
		...
		$rps_result_students = array(
			...
			'student_meta'      => 'roll_no:Index No, registration_no:Student ID, dob:Date of Birth, department:Class, batch:Batch, semester:Term',
		);
		...
		$rps_result_results = array (
			...
			'batch_error_text'      => __('Please Select a Batch From List.', $this->TD),
			'semester_error_text'   => __('Please Select a Term From List.', $this->TD),
			'student_meta'      => 'name:Name, roll_no:Index No, registration_no:Student ID, dob:Date of Birth, department:Class, batch:Batch, semester:Term',
