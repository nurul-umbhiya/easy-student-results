...
final class RPS_Shortcodes_StudentList extends RPS_Shortcodes_Abstract {
    ...
    private function searchForm() {
                        ...
                        <div class="form-group">
                            <?php if(!empty($batches)) : ?>
                                <select name="batch_id" id="batch_id" class="form-control">
                                    <option value=""><?php echo isset($this->options['batch_text']) ? $this->options['batch_text'] : __('Select Session', $this->TD); ?></option>
                                    <?php
        ...
        <script type="text/javascript">
            ...
            var select_batch        = '<?php echo isset($this->options['batch_text'])       ? $this->options['batch_text']          : __('Select Session', $this->TD); ?>';
