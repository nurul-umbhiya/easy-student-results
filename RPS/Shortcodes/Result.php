...
final class RPS_Shortcodes_Result extends RPS_Shortcodes_Abstract
{
    ...
    ?>
                    ...
                    <?php  echo $nonce; ?>
                        ...
                        <div class="form-group">
                            <select name="batch_id" id="batch_id" class="form-control">
                                <option
                                    value=""><?php echo isset($this->options['batch_text']) ? esc_attr($this->options['batch_text']) : __('Session', $this->TD); ?></option>
                                <?php
        ...
        <script>
            ...
            var select_batch        = '<?php echo isset($this->options['batch_text'])       ? esc_sql( $this->options['batch_text'] )         : __('Select Session', $this->TD); ?>';
            ...
            var batch_error_text   = '<?php echo isset($this->options['batch_error_text'])              ? esc_sql( $this->options['batch_error_text'] )         : __('Please Select a Session From List.', $this->TD); ?>';
