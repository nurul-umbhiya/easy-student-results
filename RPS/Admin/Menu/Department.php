        ...
        if ( current_user_can($role) && isset($_GET['delete_department']) && wp_verify_nonce($_GET['delete_department'], 'delete_department_' . $department_id)) {
            ...
            if ( !$error ) {
	            ...
	            if ( is_array( $result ) && ! empty( $result ) ) {
		            $error          = true;
		            $this->errors[] = __( 'You can\'t delete this department. Class is assigned to Students. Please delete assigned Students or reassign Students to another department first to delete this department', $this->TD );
	            }
            }
            ...
            if ( !$error ) {
	            ...
	            if ( is_array( $result ) && ! empty( $result ) ) {
		            $error          = true;
		            $this->errors[] = __( 'You can\'t delete this department. Class is assigned to Subjects. Please delete assigned Subjects or reassign Subjects to another department first to delete this department', $this->TD );
	            }
            }
            ...
            if ( !$error ) {
	            ...
	            if ( is_array( $result ) && ! empty( $result ) ) {
		            $error          = true;
		            $this->errors[] = __( 'You can\'t delete this department. Class is assigned to Exams. Please delete assigned Exams or reassign Exams to another department first to delete this department', $this->TD );
	            }
            }
                ...
                <table class="wp-list-table widefat fixed striped tags" style="width: 100%;">
                    <thead>
                        <tr>
                            ...
                            <th scope="col"><?php _e('Term', $this->TD) ?></th>
