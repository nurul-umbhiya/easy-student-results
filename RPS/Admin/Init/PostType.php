    ...
    public function courses() {
        register_post_type(RPS_Result_Management::COURSE,
            array(
                'label'                     => 'Subjects',
                'labels' => array (
                    'name'                  => __( 'Subjects', RPS_Result_Management::TD ),
                    'singular_name'         => __( 'Subject', RPS_Result_Management::TD ),
                    'menu_name'             => _x( 'Subjects', 'Admin menu name', RPS_Result_Management::TD ),
                    'add_new'               => __( 'Add Subject', RPS_Result_Management::TD ),
                    'add_new_item'          => __( 'Add New Subject', RPS_Result_Management::TD ),
                    'edit'                  => __( 'Edit', RPS_Result_Management::TD ),
                    'edit_item'             => __( 'Edit Subject', RPS_Result_Management::TD ),
                    'new_item'              => __( 'New Subject', RPS_Result_Management::TD ),
                    'view'                  => __( 'View Subject', RPS_Result_Management::TD ),
                    'view_item'             => __( 'View Subject', RPS_Result_Management::TD ),
                    'search_items'          => __( 'Search Subjects', RPS_Result_Management::TD ),
                    'not_found'             => __( 'No Subjects found', RPS_Result_Management::TD ),
                    'not_found_in_trash'    => __( 'No Subjects found in trash', RPS_Result_Management::TD ),
                    'parent'                => __( 'Parent Subject', RPS_Result_Management::TD )
                ),

                'description'               => __( 'This is where you can add new Subjects.', RPS_Result_Management::TD ),
